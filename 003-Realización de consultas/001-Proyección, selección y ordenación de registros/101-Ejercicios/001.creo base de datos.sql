...
--crear usuario con permisos para la base de datos
CREATE USER 'usuario_clientes'@'localhost' IDENTIFIED BY 'Clientes123$';
GRANT ALL PRIVILEGES ON clientes.* TO 'usuario_clientes'@'localhost';
FLUSH PRIVILEGES;
